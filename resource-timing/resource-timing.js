...
window.onload =
    function () {
        ...
        [
            ...
            // VSO #2379187: { initiator: "img",            response: greenPng,      mime: mimePng },
        ...
        [
            ...
            // VSO #2379187: { initiator: "img",            responsePart1: greenPng.substring(0, greenPng.length / 2), responsePart2: "0x" + greenPng.substring(greenPng.length / 2, greenPng.length),       mime: mimePng },
        ...
        function assertInvariants(test, done) {
            // VSO #2379187: Yield for 100ms to workaround a suspected race where window.onload fires before
            //               all script visible side-effects from the wininet/urlmon thread have finished.
            window.setTimeout(
                test.step_func(
                    function () {
                        performance
